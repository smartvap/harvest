...
:start
echo 启动Derby数据库...
"%JAVA_HOME%"\bin\java.exe -cp .;..\libs\derby\derby.jar;..\libs\derby\derbyrun.jar;..\libs\derby\derbynet.jar;..\libs\derby\derbytools.jar -Dderby.system.home=../derby org.apache.derby.drda.NetworkServerControl start -h localhost -p 1527
